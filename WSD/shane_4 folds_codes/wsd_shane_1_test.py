...
from wsd_shane_1_train import sens_prob, tag_types
...
fp_train_sorted_decision_list = codecs.open('shane_1_train_sorted_decision_list.txt','r','utf_8')  #* اشاره گر به فايل متني که ليست تصميم در آن نوشته مي شود
...
print('shane_test_1 Precision =', Precision)
print()
