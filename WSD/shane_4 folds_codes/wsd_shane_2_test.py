...
from wsd_shane_2_train import sens_prob, tag_types
...
fp_train_sorted_decision_list = codecs.open('shane_2_train_sorted_decision_list.txt','r','utf_8')  #* اشاره گر به فايل متني که ليست تصميم در آن نوشته مي شود
...
print('shane_test_2 Precision =', Precision)
print()
