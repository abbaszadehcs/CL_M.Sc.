...
fp_train_sorted_decision_list = codecs.open('krm_3_train_sorted_decision_list.txt','r','utf_8')  #* اشاره گر به فايل متني که ليست تصميم در آن نوشته مي شود
...
print('krm_test_3 Precision =', Precision)
print()
