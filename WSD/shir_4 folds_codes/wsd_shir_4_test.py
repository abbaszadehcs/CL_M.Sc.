...
from wsd_shir_4_train import sens_prob, tag_types
...
fp_train_sorted_decision_list = codecs.open('shir_4_train_sorted_decision_list.txt','r','utf_8')  #* اشاره گر به فايل متني که ليست تصميم در آن نوشته مي شود
...
print('shir_test_4 Precision =', Precision)
print()
